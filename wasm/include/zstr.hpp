...
namespace zstr
{
    ...
    public:
        ...
        int deflate_loop( int flush )
        {
            while ( true )
            {
                ...
                std::streamsize sz = sbuf_p->sputn( out_buff.get(),
                    reinterpret_cast<decltype( out_buff.get() )>( zstrm_p->next_out ) - out_buff.get() );
                if ( sz
                     != reinterpret_cast<decltype( out_buff.get() )>( zstrm_p->next_out ) - out_buff.get() )
                {
    ...
    namespace detail
    {
        ...
        template <typename FStream_Type> struct strict_fstream_holder
        {
